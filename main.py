...
def financial_keyfigures(input_string):
    ...
    return json.dumps(key_metrics, indent=4)
...
if __name__ == "__main__":
    ...
    tools = [basic_calculator, reverse_string, financial_keyfigures]
    ...
    print("3. Get key financial figures\n")
    print("4. Answer general questions\n")
